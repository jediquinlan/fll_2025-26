...
def send_cell(x, y, color_code):
    stdout.buffer.write(MARKER + ustruct.pack('>HHB', x, y, color_code))


def accuTurn(target_angle, tolerance=0.05, max_speed=80):
    while True:
        ...
        direction = speed if angle_difference > 0 else -speed
